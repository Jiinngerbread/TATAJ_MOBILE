    ...
    return new Container(
      ...
      child: new ListView(
        ...
        children: <Widget>[
          ...
          _buildListItem("Email: ana@tataj.com ", Icons.mail, () {}),
          _buildListItem("Contact: 876-229-0099",Icons.call, () {}),
          _buildListItem("Personal Goals", (IconData(0xe900, fontFamily: 'ic_investment_filled')), () {}),
          _buildListItem("Peer Goals ", (IconData(0xe900, fontFamily: 'ic_peer')), () {}),
          _buildListItem("Group Goals", (IconData(0xe900, fontFamily: 'ic_group_master')), () {}),
